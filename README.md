**Declaration: I contributed to the majority of this project, including the preparation of test files and the implementation of the analytical section's code. As you jump into the <a href="https://github.com/Nurayend/programming-for-AI-assessments">orriginal repository</a>, can see my contribution there 
**
